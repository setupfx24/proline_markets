...
async def send_welcome_email(
    ...
    inner = f"""
        <p>Hi {name}, your email is verified and your Proline Markets <strong>profile</strong> is now active. 🎉</p>
        {creds_html}
    ...
    text = (
        f"Welcome, {name}!\nYour email is verified and your Proline Markets profile is active.{cred_text}"
