                  ...
                  {downline.length === 0 ? (
                    ...
                    downline.map((node, idx) => (
                      <View key={node._id || idx} style={[styles.downlineItem, { backgroundColor: colors.bgCard, borderColor: colors.border }]}>
                        <View style={[styles.downlineAvatar, { backgroundColor: node.isIB ? '#22c55e30' : '#33333' }]}>
                          <Text style={[styles.avatarText, { color: node.isIB ? '#22c55e' : '#888' }]}>{node.firstName?.charAt(0) || '?'}</Text>
                        </View>
                        ...
                        <View style={[styles.downlineBadge, { backgroundColor: node.isIB ? '#22c55e20' : '#33333' }]}>
                          <Text style={[styles.downlineBadgeText, { color: node.isIB ? '#22c55e' : '#888' }]}>
...
const styles = StyleSheet.create({
  ...
  applyIconContainer: { width: 80, height: 80, borderRadius: 40, backgroundColor: '#22c55e20', justifyContent: 'center', alignItems: 'center', marginBottom: 16 },
  ...
  applyBtn: { backgroundColor: '#22c55e', paddingHorizontal: 40, paddingVertical: 16, borderRadius: 12 },
  ...
  progressPercent: { color: '#22c55e', fontSize: 12, fontWeight: '600' },
  ...
  referralAvatar: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#22c55e30', justifyContent: 'center', alignItems: 'center' },
  avatarText: { color: '#22c55e', fontSize: 16, fontWeight: 'bold' },
  ...
  withdrawBtn: { backgroundColor: '#22c55e', padding: 16, borderRadius: 12, alignItems: 'center' },
