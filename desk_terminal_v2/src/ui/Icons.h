...
// Share — a node graph: the arrow-out glyph reads as "export", which is not
// what this does. This is a link handed to someone else.
inline QIcon share(const QColor& c, int px = 18) {
    return detail::render(detail::wrap(
        ...
        "<line x1='15.4' y1='6.5' x2='8.6' y2='10.5'/>"), c, px);
}
