...
public:
    ...
    // Site root of the browser terminal: the target of the Web Terminal button
    // and the host of the public share cards. Kept separate from restBase
    // rather than derived from it — a build pointed at a staging or local API
    // still belongs to a web front end on its own host.
