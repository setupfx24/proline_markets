...
export default function KycPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success('KYC submitted â€” our team will review within 1â€“2 business days');
      ...
      <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden">
          ...
          <section className="relative overflow-hidden rounded-xl border border-border-primary bg-card">
            ...
            <div className="relative z-10 px-4 sm:px-6 py-5 sm:py-7">
              ...
              <p className="text-sm text-text-secondary mt-1 max-w-2xl">
                Complete identity verification to unlock deposits, withdrawals, and live trading â€” same secure styling as
                the rest of ProlineMarkets.
              </p>
            </div>
          </section>

        {/* Approved â€” full success state */}
        {isVerified && (
        ...
        {!isVerified && (
          <>
              ...
              <div className="p-5 md:p-6 border-b border-border-primary flex flex-wrap items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-text-secondary mt-0.5">
                    Secure KYC â€” upload government ID, selfie, and proof of address
                  </p>
                </div>
              ...
              {isReview && (
                <div className="p-6 md:p-8 space-y-4">
                  ...
                  <p className="text-sm text-text-secondary leading-relaxed">
                    Your documents are under review. This usually takes <span className="text-text-primary font-medium">24â€“48 hours</span>.
              ...
              {(isNotStarted || isRejected) && (
                <div className="p-8 md:p-10 text-center space-y-5">
                  ...
                  <button
                    type="button"
                    onClick={openForm}
                    className="inline-flex items-center justify-center gap-2 w-full sm:w-auto min-w-[240px] px-8 py-3.5 rounded-xl text-sm font-bold border-2 border-accent bg-accent text-black hover:brightness-110 transition-all shadow-[0_0_24px_rgba(34,197,94,0.35)]"
                  >
            ...
            {/* Info sections â€” only before review / same as reference */}
            {(isNotStarted || isRejected) && (
              <>
          ...
          <div className="relative w-full sm:max-w-lg max-h-[92dvh] overflow-y-auto rounded-t-2xl sm:rounded-2xl border border-border-primary bg-card shadow-2xl sidebar-scroll">
            ...
            <div className="p-5 space-y-5">
              ...
              <button
                ...
                disabled={submitting}
                className="w-full py-3.5 rounded-xl border-2 border-accent bg-accent hover:brightness-110 disabled:opacity-60 text-black font-bold text-sm transition-all flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(34,197,94,0.25)]"
              >
                {submitting ? (
                  <>
