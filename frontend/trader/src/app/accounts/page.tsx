...
export default function AccountsPage() {
  ...
  const newAccountCtaClass =
    'inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-lg border-2 border-[#22c55e] text-[#22c55e] text-sm font-bold hover:bg-[#22c55e]/10 transition-colors shrink-0';
        ...
        <div className="space-y-4 p-1">
          ...
          <div className="flex flex-col-reverse sm:flex-row sm:justify-end gap-2 pt-3 border-t border-border-primary">
            ...
            <Link
              href="/kyc"
              onClick={() => setKycGateOpen(false)}
              className="px-5 py-2.5 rounded-lg bg-[#22c55e] text-white text-sm font-bold hover:bg-[#16a34a] transition-colors text-center"
            >
              Complete KYC
            </Link>
          </div>
                ...
                return (
                  ...
                  >
                    {active ? (
                      <span
                        key={tab}
                        className="relative inline-block animate-wallet-main-tab-text drop-shadow-[0_0_20px_rgba(34,197,94,0.7)]"
                      >
                        {t.label}
                      </span>
                    ) : (
              ...
              {liveAccounts.length === 0 ? (
                ...
                <div className="space-y-4">
                    ...
                    {(() => {
                      ...
                      return (
                        <div className="rounded-xl border border-accent/35 bg-bg-base p-4 flex items-center gap-3">
                          <div className="w-10 h-10 rounded-full bg-[#22c55e]/12 flex items-center justify-center text-[#22c55e] shrink-0">
                  ...
                  <div className="pt-3 space-y-2 border-t border-border-primary">
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      ...
                      <button
                        ...
                        className="text-sm font-bold text-[#22c55e] hover:underline disabled:opacity-40 disabled:pointer-events-none"
                      >
                  ...
                  <button
                    ...
                    className="w-full py-3.5 rounded-xl bg-[#22c55e] text-white text-base font-bold hover:bg-[#16a34a] disabled:opacity-45 disabled:pointer-events-none transition-colors flex items-center justify-center gap-2"
                  >
      ...
      <div className="flex items-start gap-3 flex-wrap">
        ...
        <div className="text-right">
          ...
          <p className={clsx(
            ...
            risk.current_drawdown_pct > 0 ? 'text-red-400' : 'text-[#22c55e]',
          )}>
      ...
      <div className="mt-4 flex flex-col sm:flex-row sm:items-end gap-3 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="w-20 px-2 py-1.5 rounded-lg border border-border-primary bg-bg-input text-sm text-text-primary font-mono tabular-nums outline-none focus:border-[#22c55e]/40 disabled:opacity-50"
          />
        ...
        <div className="flex items-center gap-2 sm:ml-auto">
          ...
          <button
            ...
            onClick={onSave}
            disabled={saving}
            className="inline-flex items-center justify-center px-4 py-1.5 rounded-lg bg-[#22c55e] text-white text-xs font-bold hover:bg-[#16a34a] transition-colors disabled:opacity-60"
          >
            {saving ? 'Saving...' : 'Save'}
          </button>
        </div>
      ...
      >
        <span
          className={clsx(
            ...
            row.is_demo ? 'bg-sky-400 shadow-[0_0_6px_rgba(56,189,248,0.7)]' : 'bg-[#22c55e] shadow-[0_0_6px_rgba(34,197,94,0.7)]',
          )}
          aria-hidden
        />
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-x-4 sm:gap-x-6 gap-y-2 sm:gap-y-3">
            ...
            <div className="min-w-0">
              ...
              <div className="flex items-center gap-1">
                <span className={clsx('text-sm sm:text-lg font-bold tabular-nums font-mono truncate', pnlPositive ? 'text-[#22c55e]' : 'text-red-400')}>
                  ~{' '}{pnlPositive ? '+' : ''}{fmt(pnl, row.currency)}
                </span>
              </div>
              <p className={clsx('text-[10px] sm:text-xs font-semibold tabular-nums', pnlPositive ? 'text-[#22c55e]/70' : 'text-red-400/70')}>
            ...
            {isManagedAccount ? (
              <>
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg bg-[#22c55e] text-white text-sm font-bold hover:bg-[#16a34a] transition-colors"
                >
                  <BookOpen size={16} />
                  View Trades
                </Link>
              ...
              <>
                ...
                <Link
                  ...
                  prefetch
                  onClick={(e) => { e.stopPropagation(); onTradePrepare(); }}
                  className="inline-flex items-center justify-center gap-1.5 px-4 sm:px-5 py-2 sm:py-2.5 rounded-lg bg-[#22c55e] text-white text-xs sm:text-sm font-bold hover:bg-[#16a34a] transition-colors"
                >
                  Trade
