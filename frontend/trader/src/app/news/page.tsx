              ...
              <div className="flex items-center gap-2 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs sm:text-sm text-text-secondary mt-0.5">
                    Calendar events and live headlines â€” ProlineMarkets theme
                  </p>
                </div>
              </div>
              {mainTab === 'calendar' && (
              ...
              {(
                ...
                return (
                  ...
                  >
                    ...
                    {active ? (
                      <span className="relative inline-block animate-wallet-main-tab-text drop-shadow-[0_0_20px_rgba(34,197,94,0.7)]">
                        {label}
                      </span>
                    ) : (
              ...
              {mainTab === 'calendar' ? (
                <>
                  ...
                  <div className="flex border-b border-border-primary mb-4 overflow-x-auto">
                    {dayTabs.map((tab) => (
                      ...
                      >
                        {tab.label}
                        {dayTab === tab.id && (
                          <span className="absolute bottom-0 left-2 right-2 h-0.5 rounded-full bg-accent shadow-[0_0_10px_rgba(34,197,94,0.5)]" />
                        )}
                      </button>
                    ))}
                  </div>
                  ...
                  <div className="rounded-xl border border-border-primary bg-card overflow-hidden">
                    {loading ? (
                      <div className="py-16 flex flex-col items-center justify-center gap-2 text-text-secondary">
                        ...
                        <span className="text-sm text-text-primary">Loading eventsâ€¦</span>
                      </div>
                    ) : error ? (
                  ...
                  <p className="text-center text-xs text-text-tertiary mt-6">
                    Data from <code className="text-text-secondary">/api/economic-calendar</code> â€” connect your
                    provider when ready.{' '}
                    <a
