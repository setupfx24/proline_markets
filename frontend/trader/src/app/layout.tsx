  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        {/* Next 15 emits only the standard `mobile-web-app-capable`, which
            Safari understands from 17.4. Older iPhones need the apple-prefixed
            one or the home-screen icon opens a normal Safari tab with the
            address bar instead of the app. */}
