      ...
      <div className="page-main space-y-4 sm:space-y-6 text-text-primary">
        ...
        {invalidAccountParam ? (
          <div className="rounded-xl border border-amber-500/35 bg-amber-500/10 px-4 py-3 text-sm text-text-primary">
            ...
            <Link href="/portfolio" className="font-semibold text-[#22c55e] underline underline-offset-2 hover:text-[#16a34a]">
              Reset
            </Link>
          </div>
        ) : null}
        ...
        {validAccountId ? (
          <div className="rounded-xl border border-[#22c55e]/30 bg-[#22c55e]/10 px-4 py-3 flex flex-wrap items-center justify-between gap-3">
            <div>
              <p className="text-[10px] font-bold uppercase tracking-wider text-[#22c55e]">Account scope</p>
            ...
            <Link
              href="/portfolio"
              className="text-xs font-semibold text-[#22c55e] hover:text-[#16a34a] underline underline-offset-2 shrink-0"
            >
              View all accounts
            </Link>
          </div>
                  ...
                  return nums.map((n) => (
                    <button
                      ...
                      className={clsx(
                        ...
                        n === page
                          ? 'bg-[#22c55e] text-text-inverse border-[#22c55e]'
