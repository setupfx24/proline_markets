...
export const NAV_ITEMS = [
  { label: "Home",        href: "/" },
  {
    ...
    children: [
      ...
      { label: "Pro Standard STP",        href: "/accounts/pro-standard-stp" },
      { label: "ECN Commission Free Ac",  href: "/accounts/ecn-commission-free" },
      { label: "Proline Premium Ac",      href: "/accounts/proline-premium" },
      { label: "Try Demo Ac",             href: "/accounts/demo" },
      { label: "Crest",                   href: "/accounts/crest" },
    ],
  },
  {
    label: "Markets",
...
export const PLATFORM_SECTION = {
  ...
  title: "Use NextGen Get Exclusive Experience with Forex",
...
export const FAQ = [
  ...
  { q: "Which account types are available?",                          a: "We offer Pro Standard STP, ECN Commission Free Ac and Proline Premium Ac for live trading, plus a free Demo account so you can practice risk-free." },
  { q: "What is the minimum deposit?",                                a: "Pro Standard STP starts at $100, ECN Commission Free Ac at $250, and Proline Premium Ac at $5,000. The Demo account is completely free." },
...
export const ACCOUNT_TYPES = [
  {
    ...
    secondaryCta: { label: "More Info",       href: "/accounts/pro-standard-stp" },
  },
  {
    name: "ECN Commission Free Ac",
    ...
    featured: true,
    primaryCta: { label: "Open Your Account", href: "/auth/login" },
    secondaryCta: { label: "More Info",       href: "/accounts/ecn-commission-free" },
  },
  {
    name: "Proline Premium Ac",
    ...
    featured: false,
    primaryCta: { label: "Open Your Account", href: "/auth/login" },
    secondaryCta: { label: "More Info",       href: "/accounts/proline-premium" },
  },
  {
    name: "Try Demo Ac",
    slug: "demo",
  ...
  },
  {
    name: "Crest",
    slug: "crest",
    tagline: "Top-tier account for elite traders",
    badge: "New",
    minDeposit: "$10000",
    leverage: "Up to 1:200",
    orderVolume: "0.01 - 500 lots",
    spread: "From 0.0 pips",
    platforms: ["MT5", "WebTrader", "Mobile App", "VPS"],
    features: ["Raw interbank pricing", "Dedicated dealer access", "VPS hosting included", "Priority withdrawal queue"],
    featured: false,
    primaryCta: { label: "Open Your Account", href: "/auth/login" },
    secondaryCta: { label: "More Info",       href: "/accounts/crest" },
  },
];
