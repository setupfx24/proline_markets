 ...
 * `public/charting_library/` to `ProlineMarketsDatafeed` (history = gateway
...
const CHART_SAVE_KEY = 'proline_chart_layout_v1';
...
export default function ChartingLibraryChart() {
  ...
  useEffect(() => {
    ...
    loadChartingLibrary().then(() => {
      ...
      const w = new Ctor({
        ...
        // Faint Proline Markets/symbol watermark in the chart background (restores the
  ...
  return (
    <div className="relative w-full h-full min-h-[320px]">
      ...
      {/* Proline Markets logo watermark — faint, centered, non-interactive. Sits over the
