          ...
          <div className="text-[11px] font-mono font-semibold tabular-nums inline-flex items-center justify-end gap-0.5 text-text-primary leading-tight">
            ...
            {cur != null &&
              (priceDown ? (
                ...
                <TrendingUp className="w-3 h-3 text-[#22c55e]" aria-hidden />
              ))}
          </div>
        </div>
      </div>
                    ...
                    <div className="flex flex-col items-end gap-0.5 shrink-0">
                      ...
                      <span
                        className={clsx(
                          ...
                          totalPnl >= 0 ? 'text-[#22c55e]' : 'text-[#ef5350]',
                        )}
                      >
                ...
                {tabs.map((tab) => (
                  <button
                    ...
                    className={clsx(
                      ...
                      activeTab === tab.id
                        ? clsx('text-text-primary border-[#22c55e]', 'bg-bg-secondary/70')
                        : clsx(
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              ...
                              <span className={clsx('text-[10px] px-1.5 py-0.5 rounded-sm font-medium', pos.trade_type === 'copy_trade' ? 'bg-info/15 text-info' : 'bg-success/15 text-success')}>
                                {pos.trade_type === 'copy_trade' ? 'Copy' : pos.trade_type === 'algo_trade' ? 'Algo' : 'Real'}
                              </span>
                            </div>
